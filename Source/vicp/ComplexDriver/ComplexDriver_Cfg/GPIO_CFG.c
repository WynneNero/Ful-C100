...
const Sig_DioChannelInConfigType Sig_InConfig[SIG_DIO_IN_NUM]=
{
	{TRUE, GPIO_PORT_8, GPIO_PIN_5, E_DIO}//,SIG_DI_SOCWDG
 	,{TRUE, GPIO_PORT_8, GPIO_PIN_4, E_DIO}//,SIG_DI_ACC
...
const Sig_DioChannelOutConfigType Sig_OutConfig[SIG_DIO_OUT_NUM]=
{
 ...
 ,{ GPIO_PORT_1,GPIO_PIN_3,E_DIO} //SIG_DO_SLC_EN	
 ,{ GPIO_PORT_1,GPIO_PIN_A,E_DIO} //SIG_DO_PS_5V0_EN
 ...
 //,{ GPIO_PORT_1,GPIO_PIN_B,E_DIO} // SIG_DO_SOC_RVC
};
