...
#define DESC_SUB_VERSION                                             0x28
#define DESC_BUGFIX_VERSION                                          0x01
...
#define DESC_IMPLEMENTATION_MAGIC_NUMBER                             15296
...
/* SvcHead table size. */
#define kDescSvcHeadNumItems                                         16
/* SvcInst table size. */
#define kDescSvcInstNumItems                                         32
/* SvcInstHeadEx table size. */
#define kDescSvcInstHeadExtNumItems                                  37
/* Context modes */
...
#define DESC_ADD_SUPPRESSED_FUNC_NRC                                 case 0x7f: case 0x7e: case 0x22:
...
#define kDescNumPids                                                 22
/* Invalid handle after PID lookup */
#define kDescInvalidPidHandle                                        ((DescMemPidInstIndex)kDescNumPids)

#define kDescNumRids                                                 6
#define kDescNumRidInst                                              8
#define kDescNumRidControlTypes                                      2
...
static void DESC_API_CALLBACK_TYPE DescOemGetLevel_1_Request_Seed(DescMsgContext* pMsgContext);
static void DESC_API_CALLBACK_TYPE DescOemSendLevel_1_Request_Seed_Key(DescMsgContext* pMsgContext);
...
V_MEMROM0 static V_MEMROM1 DescMsgItem V_MEMROM2 g_descSidMap[kDescSvcIdMapSize] = 
{
  ...
  0xFF, 0x09, 0xFF, 0xFF, 0x0A, 0xFF, 0x0B, 0x0C, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x0D, 0xFF, 
...
V_MEMROM0 static V_MEMROM1 DescSvcHead V_MEMROM2 g_descSvcHead[kDescSvcHeadNumItems] = 
{
  ...
  { 0x01, 1, 1, 0x01, 0x01, 1, 1, 1, 0x00, 0x07, 0x00,  2,  6,  5 } /* $19 */, 
  { 0x01, 0, 0, 0x03, 0x03, 0, 1, 0, 0x00, 0x07, 0x00,  1, 11, 10 } /* $22 */, 
  { 0x01, 1, 1, 0x01, 0x01, 1, 1, 1, 0x00, 0x04, 0x00,  2, 12, 10 } /* $27 */, 
  { 0x01, 1, 1, 0x03, 0x03, 1, 1, 1, 0x00, 0x04, 0x00,  2, 14, 12 } /* $28 */, 
  { 0x07, 2, 2, 0x01, 0x01, 0, 1, 0, 0x00, 0x07, 0x00,  4, 16, 14 } /* $2E */, 

  { 0x0F, 3, 3, 0x01, 0x01, 0, 1, 0, 0x00, 0x04, 0x00,  4, 23, 28 } /* $2F */, 
  { 0x01, 0, 0, 0x03, 0x03, 1, 1, 1, 0x00, 0x06, 0x00,  1, 25, 34 } /* $31 */, 
  { 0x01, 0, 0, 0x01, 0x01, 0, 1, 0, 0x00, 0x02, 0x00,  1, 26, 34 } /* $34 */, 
  { 0x01, 0, 0, 0x01, 0x01, 0, 1, 0, 0x00, 0x02, 0x00,  1, 27, 34 } /* $36 */, 
  { 0x01, 0, 0, 0x01, 0x01, 0, 1, 0, 0x00, 0x02, 0x00,  1, 28, 34 } /* $37 */, 
  { 0x01, 1, 1, 0x03, 0x03, 1, 1, 1, 0x00, 0x07, 0x00,  2, 29, 34 } /* $3E */, 
  { 0x01, 1, 1, 0x03, 0x03, 1, 1, 1, 0x00, 0x04, 0x00,  2, 30, 35 } /* $85 */, 
  { 0x00, 0, 0, 0x00, 0x00, 0, 1, 0, 0x00, 0x00, 0x00,  1, 32, 37 } /* $FF */
};
...
{
  {   2, { 0x03, 0x03, 0 }, { 0x07, 0x03, 0x00 },                      0,    0, DescOemStartSessionDefault } /* $10 $1 */, 
  {   2, { 0x01, 0x01, 0 }, { 0x06, 0x03, 0x00 },                      1,    0, DescOemStartSessionProgramming } /* $10 $2 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x05, 0x03, 0x00 },                      2,    0, DescOemStartSessionExtended } /* $10 $3 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x07, 0x03, 0x00 },                      3,    0, ApplDescEcuResetHard } /* $11 $1 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x07, 0x03, 0x00 },                      4,    0, ApplDescEcuResetSoft } /* $11 $3 */, 
  {   4, { 0x03, 0x03, 0 }, { 0x05, 0x03, 0x00 }, kDescStateNoTransition,    0, ApplDescClearDiagInfo } /* $14 */, 
  {   3, { 0x01, 0x01, 0 }, { 0x05, 0x03, 0x00 }, kDescStateNoTransition,    0, ApplDescReadDtcRNODTCBSM } /* $19 $1 */, 
  {   3, { 0x01, 0x01, 0 }, { 0x05, 0x03, 0x00 }, kDescStateNoTransition,    0, ApplDescReadDtcRDTCBSM } /* $19 $2 */, 

  {   6, { 0x01, 0x01, 0 }, { 0x07, 0x03, 0x00 }, kDescStateNoTransition,    0, ApplDescReadDtcRDTCSSBDTC } /* $19 $4 */, 
  {   6, { 0x01, 0x01, 0 }, { 0x07, 0x03, 0x00 }, kDescStateNoTransition,    0, ApplDescReadDtcRDTCEDRBDN } /* $19 $6 */, 
  {   2, { 0x01, 0x01, 0 }, { 0x05, 0x03, 0x00 }, kDescStateNoTransition,    0, ApplDescReadDtcRSUPDTC } /* $19 $A */, 
  {   0, { 0x03, 0x03, 0 }, { 0x07, 0x03, 0x00 }, kDescStateNoTransition,    2, DescReadDataByIdentifier } /* $22 */, 
  {   2, { 0x01, 0x01, 0 }, { 0x04, 0x03, 0x00 }, kDescStateNoTransition,    0, DescOemGetLevel_1_Request_Seed } /* $27 $1 */, 
  {   6, { 0x01, 0x01, 0 }, { 0x04, 0x03, 0x00 },                      5,    0, DescOemSendLevel_1_Request_Seed_Key } /* $27 $2 */, 
  {   3, { 0x03, 0x03, 0 }, { 0x04, 0x03, 0x00 }, kDescStateNoTransition,    1, DescOemCommCtrlEnableRxEnableTx } /* $28 $0 */, 
  {   3, { 0x03, 0x03, 0 }, { 0x04, 0x03, 0x00 }, kDescStateNoTransition,    1, DescOemCommCtrlDisableRxDisableTx } /* $28 $3 */, 

  {  20, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidFAW_Vehicle_Identification_Number } /* $2E $F1 $90 */, 
  {  13, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidRepair_Shop_Code_and_or_Tester_Serial_Number } /* $2E $F1 $98 */, 
  {   7, { 0x01, 0x01, 0 }, { 0x06, 0x02, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidProgramming_Date } /* $2E $F1 $99 */, 
  {   7, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidECU_Installation_Date } /* $2E $F1 $9D */, 
  {  19, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidFAW_Reserved } /* $2E $F1 $A0 */, 
  {   5, { 0x01, 0x01, 0 }, { 0x07, 0x03, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidSystem_Configuration_1 } /* $2E $F1 $A1 */, 
  {  19, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    0, ApplDescWriteDidFAW_Reserved1 } /* $2E $F1 $A7 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    0, ApplDescIoCtrlRetCtrlToEcuAVS_View_change_control } /* $2F $C0 $C0 $0 */, 

  {   5, { 0x01, 0x01, 0 }, { 0x04, 0x02, 0x00 }, kDescStateNoTransition,    0, ApplDescIoCtrlShortTermAdjAVS_View_change_control } /* $2F $C0 $C0 $3 */, 
  {   0, { 0x03, 0x03, 0 }, { 0x06, 0x03, 0x00 }, kDescStateNoTransition,    0, DescRoutineControlByIdentifier } /* $31 */, 
  {   0, { 0x01, 0x01, 0 }, { 0x02, 0x02, 0x00 }, kDescStateNoTransition,    0, ApplDescRequestDownload } /* $34 */, 
  {   0, { 0x01, 0x01, 0 }, { 0x02, 0x02, 0x00 }, kDescStateNoTransition,    0, ApplDescTransferData } /* $36 */, 
  {   1, { 0x01, 0x01, 0 }, { 0x02, 0x02, 0x00 }, kDescStateNoTransition,    0, ApplDescRequestTransferExit } /* $37 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x07, 0x03, 0x00 }, kDescStateNoTransition,    0, DescOemProcessTesterPresent } /* $3E $0 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x04, 0x03, 0x00 }, kDescStateNoTransition,    0, ApplDescControlDtcSettingEnable } /* $85 $1 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x04, 0x03, 0x00 }, kDescStateNoTransition,    0, ApplDescControlDtcSettingDisable } /* $85 $2 */
};
...
V_MEMROM0 static V_MEMROM1 DescMsgItem V_MEMROM2 g_descSvcInstHeadExt[kDescSvcInstHeadExtNumItems] = 
{
  ...
  0x01, 0x02 /* $27 */, 
  0x00, 0x03 /* $28 */, 
  0xF1, 0x90, 0xF1, 0x98, 0xF1, 0x99, 0xF1, 0x9D, 0xF1, 0xA0, 0xF1, 0xA1, 0xF1, 0xA7 /* $2E */, 
  0xC0, 0xC0, 0x00, 0xC0, 0xC0, 0x03 /* $2F */, 
  0x00 /* $3E */, 
...
{
  { 0x0100,    2, { { 0x05, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDidVehicleSpeed }, 
  { 0x0101,    4, { { 0x05, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDidOdometer }, 
  { 0x0102,    1, { { 0x05, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidSupply_Voltage }, 
  { 0x0107,    1, { { 0x07, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidInstallation_status }, 
  { 0x2B00,    1, { { 0x05, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDidAVS_Calibration_Status }, 
  { 0x2B10,    1, { { 0x05, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidAVS_View_change_status }, 
  { 0xC0C0,    1, { { 0x07, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDidAVS_View_change_control }, 
  { 0xF183,   12, { { 0x07, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidSupplier_ECU_Boot_Software_Version_Number }, 

  { 0xF187,   16, { { 0x07, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDidFAW_Part_Number }, 
  { 0xF189,   16, { { 0x07, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDidFAW_ECU_Software_Version_Number }, 
  { 0xF190,   17, { { 0x07, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDidFAW_Vehicle_Identification_Number }, 
  { 0xF191,   16, { { 0x07, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDidFAW_ECU_Hardware_Version_Number }, 
  { 0xF192,   16, { { 0x07, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDidSupplier_ECU_Hardware_Number }, 
  { 0xF193,   16, { { 0x07, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDidSupplier_ECU_Hardware_Version_Number }, 
  { 0xF194,   16, { { 0x07, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDidSupplier_ECU_Software_Number }, 
  { 0xF195,   16, { { 0x07, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDidSupplier_ECU_Software_Version_Number }, 

  { 0xF198,   10, { { 0x07, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDidRepair_Shop_Code_and_or_Tester_Serial_Number }, 
  { 0xF199,    4, { { 0x07, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDidProgramming_Date }, 
  { 0xF19D,    4, { { 0x07, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDidECU_Installation_Date }, 
  { 0xF1A0,   16, { { 0x07, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDidFAW_Reserved }, 
  { 0xF1A1,    2, { { 0x07, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescReadDidSystem_Configuration_1 }, 
  { 0xF1A7,   16, { { 0x07, 0x03, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescReadDidFAW_Reserved1 }
};
/* Table of all RIDs' */
V_MEMROM0 static V_MEMROM1 vuint16 V_MEMROM2 g_descRidLookUpTable[kDescNumRids] = 
{
  0x0202, 0x0205, 0xE100, 0xE101, 0xFF00, 0xFF01
};
...
{
  { { 0x06, 0x03, 0x00 }, { 0x03, 0x03, 0 } } /* $0202 */, 
  { { 0x06, 0x03, 0x00 }, { 0x03, 0x03, 0 } } /* $0205 */, 
  { { 0x06, 0x03, 0x00 }, { 0x03, 0x03, 0 } } /* $e100 */, 
  { { 0x06, 0x03, 0x00 }, { 0x03, 0x03, 0 } } /* $e101 */, 
  { { 0x02, 0x02, 0x00 }, { 0x01, 0x01, 0 } } /* $ff00 */, 
  { { 0x02, 0x02, 0x00 }, { 0x01, 0x01, 0 } } /* $ff01 */
};
/* Table of all RIDs' instances. */
V_MEMROM0 static V_MEMROM1 DescRidInst V_MEMROM2 g_descRIDInstInfo[kDescNumRidInst] = 
{
  {   3, { { 0x06, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlStartCheck_Programming_Integrity } /* $31 $1 $2 $2 */, 
  {   3, { { 0x06, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlStartInstallation } /* $31 $1 $2 $5 */, 
  {   3, { { 0x06, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlStartEnter_EOL_view } /* $31 $1 $E1 $0 */, 
  {   3, { { 0x06, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlReqResEnter_EOL_view } /* $31 $3 $E1 $0 */, 
  {   3, { { 0x06, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlStartcalibration } /* $31 $1 $E1 $1 */, 
  {   3, { { 0x06, 0x03, 0x00 }, { 0x03, 0x03, 0 } }, ApplDescRtnCtrlReqRescalibration } /* $31 $3 $E1 $1 */, 
  {  12, { { 0x02, 0x02, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescRtnCtrlStartErase_Memory } /* $31 $1 $FF $0 */, 
  {   3, { { 0x02, 0x02, 0x00 }, { 0x01, 0x01, 0 } }, ApplDescRtnCtrlStartCheck_Programming_Dependence } /* $31 $1 $FF $1 */
};
                 ...
                 g_descMsgContext[DESC_CONTEXT_PARAM_VALUE].msgAddInfo.reqType) != 0)
            {
...
#endif
              {
                  ...
                  (refDescSvcInst->reqLen == g_descMsgContext[DESC_CONTEXT_PARAM_VALUE].reqDataLen))
                {
				  ...
				  if((g_descNegResCode[DESC_CONTEXT_PARAM_VALUE]==kDescNrcRejectStateSecurityAccess)
				  &&(g_descBuffer[0][0] == 0x2F))
				  {
					  if(g_descBuffer[0][4] > 0x07)
					  g_descNegResCode[DESC_CONTEXT_PARAM_VALUE] = kDescNrcRequestOutOfRange;
				   }

				  	if((g_descBuffer[0][0] == 0x27) && (g_descMsgContext[DESC_CONTEXT_PARAM_VALUE].msgAddInfo.suppPosRes == 0x01)) //delete service 27 mask 0x80 by colin fix BUG2021102500030
				  	{
                ...
                {
                /* If necessary at each ECU reset - set the penality timer always */
				  if((g_descBuffer[0][0]==0x2E)&&(g_descBuffer[0][1]==0xF1)&&(g_descBuffer[0][2]==0x99))
					{	 
					  g_descNegResCode[DESC_CONTEXT_PARAM_VALUE] = kDescNrcRequestOutOfRange;
					}
					else if((g_descBuffer[0][0]==0x27)&&(g_descBuffer[0][1]==0x04))
					{ 
					  g_descNegResCode[DESC_CONTEXT_PARAM_VALUE] = DescCheckState(&(refDescSvcInst->checkState));
					  if(g_descNegResCode[DESC_CONTEXT_PARAM_VALUE]!=kDescNrcRejectStateSession)
						  g_descNegResCode[DESC_CONTEXT_PARAM_VALUE] = kDescNrcInvalidFormat;
					}
					else if((g_descBuffer[0][0]==0x27)&&(g_descBuffer[0][1]==0x02) && (g_descMsgContext[DESC_CONTEXT_PARAM_VALUE].msgAddInfo.suppPosRes == 0x01))
					{ 
					 g_descNegResCode[DESC_CONTEXT_PARAM_VALUE] = kDescNrcSubfunctionNotSupported;
					}
					else
...
/*  ********************************************************************************
 * Function name:DescOemGetLevel_1_Request_Seed
...
static void DESC_API_CALLBACK_TYPE DescOemGetLevel_1_Request_Seed(DescMsgContext* pMsgContext)
{
  DescOemSecuritySeed(pMsgContext, kDescStateSecurityAccessLevel_1_1);
}


/*  ********************************************************************************
 * Function name:DescOemSendLevel_1_Request_Seed_Key
...
static void DESC_API_CALLBACK_TYPE DescOemSendLevel_1_Request_Seed_Key(DescMsgContext* pMsgContext)
{
  DescOemSecurityKey(pMsgContext, kDescStateSecurityAccessLevel_1_1);
}
...
*
*******************************************************************************/
void DESC_API_CALL_TYPE DescDisableCommunication(void)
{
  /* Prepare for "TxEnable on ALL channels" */
  g_descCommControlInfo.subNetNumber   = kDescCommControlSubNetNumAll;
  g_descCommControlInfo.txPathState    = kDescCommControlStateDisable;
#if defined (DESC_ENABLE_RX_COMM_CONTROL)
  g_descCommControlInfo.rxPathState    = kDescCommControlStateDisable;
#endif
  g_descCommControlInfo.msgTypes       = kDescCommControlMsgTypeAll;
...
{
///* If necessary at each ECU reset - set the penality timer always */
//	g_descSecureNrOfAttempts = SecM_GetAttCounter();
//# if defined (DESC_ENABLE_TOTAL_ATTEMPT_COUNTER)
