/* -----------------------------------------------------------------------------
  ...
  Generated by CANdelaGen, Wed Dec 09 20:39:10 2020
...
//# error "Replace the <DIAG_NORMAL_ADD_RES_ID> and <DIAG_NORMAL_ADD_REQ_ID> below with the real CANids and uncomment the line!"
        TpTxSetChannelID(tpChannel, 0x72E,0x726); 
...
void DESC_API_CALLBACK_TYPE ApplDescOnTransitionSession(DescStateGroup newState, DescStateGroup formerState)
{
  ...
  /* Avoids warnings */
	...
	/*	if(newState==kDescStateSessionDefault)
	{
		app_diagnostic_current_session = 1;//ccj.get current session for F186 use
	}
	else if(newState==kDescStateSessionProgramming)
	{
		app_diagnostic_current_session = 2;//ccj.get current session for F186 use
	}
	else if(newState==kDescStateSessionExtendedDiagnostic)
	{
		app_diagnostic_current_session = 3;//ccj.get current session for F186 use
	}
	else
	{
		app_diagnostic_current_session = 1;//default status//ccj.get current session for F186 use
	}
	*/
	DescSetStateSecurityAccess(0x01);//ccj.Switch to another diagnostic session. Make sure that the security access is lost.
...
{
  CanDiagAppCallBack(DESC_11_01_HARD_RESET, pMsgContext);
...
{
	CanDiagAppCallBack(DESC_11_03_SOFR_RESET, pMsgContext);
...
{
  CanDiagAppCallBack(DESC_14_CLR_DIAGNOSTIC_INFORMATION, pMsgContext);
}
...
{
  CanDiagAppCallBack(DESC_19_04_READ_Environment_Data_Fault_Memory, pMsgContext);
}


/*  ********************************************************************************
 * Function name:ApplDescReadDtcRDTCEDRBDN (Service request header:$19 $6 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	CanDiagAppCallBack(DESC_19_06_READ_ExtDataRecord_Fault_Memory, pMsgContext);
...
/*  ********************************************************************************
 * Function name:ApplDescWriteDidFAW_Vehicle_Identification_Number (Service request header:$2E $F1 $90 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	CanDiagAppCallBack(DES_22_F190_WRITE_FAW_VECHICLE_ID_NUMBER , pMsgContext);
}


/*  ********************************************************************************
 * Function name:ApplDescWriteDidRepair_Shop_Code_and_or_Tester_Serial_Number (Service request header:$2E $F1 $98 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	CanDiagAppCallBack(DES_22_F198_WRITE_REPAIR_SHOP_CODE_AND_OR_TESTER_SERIAL_NUMBER , pMsgContext);
}


/*  ********************************************************************************
 * Function name:ApplDescWriteDidProgramming_Date (Service request header:$2E $F1 $99 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	CanDiagAppCallBack(DES_22_F199_WRITE_PROGRAMMING_DATA , pMsgContext);
}


/*  ********************************************************************************
 * Function name:ApplDescWriteDidECU_Installation_Date (Service request header:$2E $F1 $9D )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	CanDiagAppCallBack(DES_22_F19D_WRITE_ECU_INSTALLATION_DATA , pMsgContext);
}


/*  ********************************************************************************
 * Function name:ApplDescWriteDidFAW_Reserved (Service request header:$2E $F1 $A0 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	CanDiagAppCallBack(DES_22_F1A0_WRITE_FAW_RESERVED , pMsgContext);
}


/*  ********************************************************************************
 * Function name:ApplDescWriteDidSystem_Configuration_1 (Service request header:$2E $F1 $A1 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	CanDiagAppCallBack(DES_22_F1A1_WRITE_SYSTEM_CONFIGURATION_1 , pMsgContext);
}


/*  ********************************************************************************
 * Function name:ApplDescWriteDidFAW_Reserved1 (Service request header:$2E $F1 $A7 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	CanDiagAppCallBack(DES_22_F1A7_WRITE_FAW_RESERVED_1 , pMsgContext);
}


/*  ********************************************************************************
 * Function name:ApplDescIoCtrlRetCtrlToEcuAVS_View_change_control (Service request header:$2F $C0 $C0 $0 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	CanDiagAppCallBack(DESC_2F_C0C0_00_ControlToECU_AVS_VIEW_CHANGE , pMsgContext);
}


/*  ********************************************************************************
 * Function name:ApplDescIoCtrlShortTermAdjAVS_View_change_control (Service request header:$2F $C0 $C0 $3 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	CanDiagAppCallBack(DESC_2F_C0C0_03_CONTROL_AVS_VIEW_CHANGE , pMsgContext);
...
{		
  	if((commControlInfo->rxPathState & kDescCommControlStateEnable) != 0)
	 {
	   ...
	   if((kDescCommControlMsgAppl == commControlInfo->msgTypes)
		   ||(kDescCommControlMsgTypeAll == commControlInfo->msgTypes)
		   )
	   {
			   IlRxStart(CAN_Public);
	 ...
	 if((commControlInfo->txPathState & kDescCommControlStateEnable) != 0)
	 {
	   /* _DrvCanSetRxOnlineMode(commControlInfo.commCtrlChannel, g_descCommControlInfo.msgTypes); */
	   if((kDescCommControlMsgAppl == commControlInfo->msgTypes)
		   ||(kDescCommControlMsgTypeAll == commControlInfo->msgTypes)
	  ...
	  if(((VehicleSpeed[0]*0x100+VehicleSpeed[1]) >= 0x0A))   // Speed must be smaller than 10 km/h
		...
		else
		{
			...
			CanDiag_SetDelayTime();
 			DescStartRepeatedServiceCall(&Can_response);
		}
  }
  else
  {
...
# endif
  ...
  if(counter_backup!=newAttCounter)
  {
		EED_LockDataBlock(EED_nDiagData0);
		EED_Security_Counter[0] =newAttCounter;
		EED_UnlockAndSavDataBlock(EED_nDiagData0);
		counter_backup=newAttCounter;
  }
...
{
	vuint8 eep_counter;
	eep_counter = EED_Security_Counter[0];
	counter_backup = eep_counter;
	return(eep_counter);	
}


static vuint32 SecM_GetRandomSeed(void)
{
    vuint16 seed_high_2byte = 0;
    vuint16 seed_low_2byte = 0;
    vuint32 seed = 0;

    /* get 16bit random value */
    srand(CanDriver_GetSeed());
    seed_high_2byte = rand();
    seed_low_2byte = rand();
    
    /* build a 32bit random value */
    seed = (((vuint32)seed_high_2byte) << 16) & 0xFFFF0000;
    seed |= ((vuint32)seed_low_2byte) & 0x0000FFFF;
...
static vuint32 SecM_ComputeKey(void)
{
  ...
  if(g_applDescSeed!=0)
  {
	  for(i=0; i<35; i++)
	  {
		  if(g_applDescSeed & 0x80000000)
		  {
			  g_applDescSeed = g_applDescSeed << 1;
			  g_applDescSeed = g_applDescSeed^MASK;
		  }
		  else
		  {
			  g_applDescSeed = g_applDescSeed << 1;
...
//	else
	{
		g_applDescSeed = SecM_GetRandomSeed();
		/* 32Bit*/
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidVehicleSpeed (Service request header:$22 $1 $0 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
  CanDiagAppCallBack(DES_22_0100_READ_DidVehicleSpeedValue, pMsgContext);
}


/*  ********************************************************************************
 * Function name:ApplDescReadDidOdometer (Service request header:$22 $1 $1 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
  CanDiagAppCallBack(DES_22_0101_READ_DidOdometerValue, pMsgContext);
}


/*  ********************************************************************************
 * Function name:ApplDescReadDidSupply_Voltage (Service request header:$22 $01 $02 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
  CanDiagAppCallBack(DES_22_0102_READ_DidSupplyVoltageValue, pMsgContext);

}


/*  ********************************************************************************
 * Function name:ApplDescReadDidInstallation_status (Service request header:$22 $1 $7 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
  CanDiagAppCallBack(DES_22_0107_READ_DidInstallation_Status, pMsgContext);

}


/*  ********************************************************************************
 * Function name:ApplDescReadDidAVS_Calibration_Status (Service request header:$22 $2B $0 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
void DESC_API_CALLBACK_TYPE ApplDescReadDidAVS_Calibration_Status(DescMsgContext* pMsgContext)
{
	...
	CanDiagAppCallBack(DES_22_2B00_READ_DidAVS_Calibration_Status, pMsgContext);
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidAVS_View_change_status (Service request header:$22 $2B $10 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
  CanDiagAppCallBack(DES_22_2B10_READ_DidAVS_View_Change_Status, pMsgContext);
}


/*  ********************************************************************************
 * Function name:ApplDescReadDidAVS_View_change_control (Service request header:$22 $C0 $C0 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
  CanDiagAppCallBack(DES_22_C0C0_READ_Did2FCONTROL_AVS_VIEW_CHANGE, pMsgContext);
}


/*  ********************************************************************************
 * Function name:ApplDescReadDidSupplier_ECU_Boot_Software_Version_Number (Service request header:$22 $F1 $83 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
   CanDiagAppCallBack(DES_22_F183_READ_SUPPLIER_ECU_BOOT_SOFTWARE_IDENTIFICATION, pMsgContext);
}

/*  ********************************************************************************
 * Function name:ApplDescReadDidFAW_Part_Number (Service request header:$22 $F1 $87 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	CanDiagAppCallBack(DES_22_F187_READ_FAW_PART_NUMBER , pMsgContext);
}

/*  ********************************************************************************
 * Function name:ApplDescReadDidFAW_ECU_Software_Version_Number (Service request header:$22 $F1 $89 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	CanDiagAppCallBack(DES_22_F189_READ_FAW_ECU_SOFTWARE_VERSION_NUMBER , pMsgContext);
}

/*  ********************************************************************************
 * Function name:ApplDescReadDidFAW_Vehicle_Identification_Number (Service request header:$22 $F1 $90 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	CanDiagAppCallBack(DES_22_F190_READ_FAW_VECHICLE_ID_NUMBER , pMsgContext);
}

/*  ********************************************************************************
 * Function name:ApplDescReadDidFAW_ECU_Hardware_Version_Number (Service request header:$22 $F1 $91 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	CanDiagAppCallBack(DES_22_F191_READ_FAW_ECU_HARDWARE_VERSION_NUMBER , pMsgContext);
}


/*  ********************************************************************************
 * Function name:ApplDescReadDidSupplier_ECU_Hardware_Number (Service request header:$22 $F1 $92 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
  CanDiagAppCallBack(DES_22_F192_READ_SUPPLIER_ECU_HARDWARE_NUMBER , pMsgContext);

}

/*  ********************************************************************************
 * Function name:ApplDescReadDidSupplier_ECU_Hardware_Version_Number (Service request header:$22 $F1 $93 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	CanDiagAppCallBack( DES_22_F193_READ_SUPPLIER_ECU_HARDWARE_VERSION_NUMBER, pMsgContext);
}
/*  ********************************************************************************
 * Function name:ApplDescReadDidSupplier_ECU_Software_Number (Service request header:$22 $F1 $94 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
  CanDiagAppCallBack( DES_22_F194_READ_SUPPLIER_ECU_SOFTWARE_NUMBER, pMsgContext);

}


/*  ********************************************************************************
 * Function name:ApplDescReadDidSupplier_ECU_Software_Version_Number (Service request header:$22 $F1 $95 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	CanDiagAppCallBack(DES_22_F195_READ_SUPPLIER_ECU_SOFTWARE_VERSION_NUMBER , pMsgContext);
}

/*  ********************************************************************************
 * Function name:ApplDescReadDidRepair_Shop_Code_and_or_Tester_Serial_Number (Service request header:$22 $F1 $98 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	CanDiagAppCallBack(DES_22_F198_READ_REPAIR_SHOP_CODE_AND_OR_TESTER_SERIAL_NUMBER , pMsgContext);
}
...
{
	CanDiagAppCallBack( DES_22_F199_READ_PROGRAMMING_DATA, pMsgContext);
}

/*  ********************************************************************************
 * Function name:ApplDescReadDidECU_Installation_Date (Service request header:$22 $F1 $9D )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	CanDiagAppCallBack( DES_22_F19D_READ_ECU_INSTALLATION_DATA, pMsgContext);
}


/*  ********************************************************************************
 * Function name:ApplDescReadDidFAW_Reserved (Service request header:$22 $F1 $A0 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	CanDiagAppCallBack( DES_22_F1A0_READ_FAW_RESERVED, pMsgContext);
}


/*  ********************************************************************************
 * Function name:ApplDescReadDidSystem_Configuration_1 (Service request header:$22 $F1 $A1 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	CanDiagAppCallBack( DES_22_F1A1_READ_SYSTEM_CONFIGURATION_1, pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescReadDidFAW_Reserved1 (Service request header:$22 $F1 $A7 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
	CanDiagAppCallBack( DES_22_F1A7_READ_FAW_RESERVED_1, pMsgContext);
}
...
/*  ********************************************************************************
 * Function name:ApplDescRtnCtrlStartCheck_Programming_Integrity (Service request header:$31 $1 $2 $2 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRtnCtrlStartInstallation (Service request header:$31 $1 $2 $5 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
  CanDiagAppCallBack(DESC_3101_0205_START_INSTALLATION, pMsgContext);
}

/*  ********************************************************************************
 * Function name:ApplDescRtnCtrlStartEnter_EOL_view (Service request header:$31 $1 $E1 $0 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
  CanDiagAppCallBack(DESC_3101_E100_START_ENTER_EOL_VIEW, pMsgContext);

}


/*  ********************************************************************************
 * Function name:ApplDescRtnCtrlReqResEnter_EOL_view (Service request header:$31 $3 $E1 $0 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
  CanDiagAppCallBack(DESC_3103_E100_REQUEST_ROUTINE_RESULT_ENTER_EOL_VIEW, pMsgContext);

}


/*  ********************************************************************************
 * Function name:ApplDescRtnCtrlStartcalibration (Service request header:$31 $1 $E1 $1 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
  CanDiagAppCallBack(DESC_3101_E101_START_CALIBRATION, pMsgContext);

}


/*  ********************************************************************************
 * Function name:ApplDescRtnCtrlReqRescalibration (Service request header:$31 $3 $E1 $1 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
{
  CanDiagAppCallBack(DESC_3103_E101_REQUEST_ROUTINE_RESULT_START_CALIBRATION, pMsgContext);

}


/*  ********************************************************************************
 * Function name:ApplDescRtnCtrlStartErase_Memory (Service request header:$31 $1 $FF $0 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
...
/*  ********************************************************************************
 * Function name:ApplDescRtnCtrlStartCheck_Programming_Dependence (Service request header:$31 $1 $FF $1 )
 * Description: not available 
 * Returns:  nothing
 * Parameter(s):
 *   - pMsgContext->reqData:
