...
CONST(NetworkHandleType, NM_CONST) Nm_SystemToNmChannelInd[NM_NUMBER_OF_SYS_CHANNELS] = 
{
  0, 
  0xFF
};
...
CONST(Nm_LConfigType, NM_CONST) Nm_LConfiguration = 
{
  ...
  2u /* NM_NUMBER_OF_SYSTEM_CHANNELS */
};
#define NM_STOP_SEC_CONST_UNSPECIFIED
/* PRQA S 5087 1 */ /* MD_MSR_19.1 */
#include "MemMap.h"
...
/* begin Fileversion check */
      ...
      #error "The magic number of the generated file <D:\Renesas_Platform\fawhq_c100_apa_mcu\Source\vicp\ComplexDriver\CANdriver\tool\gen979\Nm_Cfg.c> is different. Please check time and date of generated files!"
  #endif
#else
  #error "The magic number is not defined in the generated file <D:\Renesas_Platform\fawhq_c100_apa_mcu\Source\vicp\ComplexDriver\CANdriver\tool\gen979\Nm_Cfg.c> "
