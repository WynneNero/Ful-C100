...
const V_hal_close  HalCloseProc[HAL_DEV_MAX]=
{
	...
	NULL,//FDL
	M4UartDriver_Close  //Do not remove
};
...
const V_hal_read HalReadProc[HAL_DEV_MAX]=
{
	...
	M4UartDriver_Read //Do not remove
};
...
const V_hal_write  HalWriteProc[HAL_DEV_MAX]=
{
	...
	M4UartDriver_Write  //Do not remove
};
...
const V_hal_block_read HalBlockReadProc[HAL_DEV_MAX]=//[HAL_BLDEV_MAX]=
{
		...
		NULL,
		EolUartDriver_Write,	/*DEV_EOLDRIVER*/  
		FDLDriver_Write_Upgrade_flag
};

const V_hal_block_write  HalBlockWriteProc[HAL_DEV_MAX]=//[HAL_BLDEV_MAX]=
{
	NULL, //FDLDriver_Read,/*FDL*/
	NULL, /*Do not remove*/
	NULL,  
