...
#ifdef IC_RH850_F1K
#define osdOSTMBaseAddr   0xFFD70000UL

#define osdICRBASE0       0xFFFEEA00UL
#define osdICRBASE1       0xFFFFB000UL
#define osdIMRBASE0       0xFFFFEAF0UL
#define osdIMRBASE1       0xFFFFB400UL

#define osdTAUJ0BaseAddr  0xFFE50000UL

#define osdTPArrivalTimerChannel   80
#define osdTPExecutionTimerChannel 81
#define osdTPBlockingTimerChannel  82
#else //IC_RH850_F1K
