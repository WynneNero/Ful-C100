...
#define UltraRadarFastTask ((TaskType)6)
#define UltraRadarSlowTask ((TaskType)7)
#define ResetTask ((TaskType)8)
...
void UltraRadarFastTaskfunc(void);
extern void InitTaskEntry(void);
void UltraRadarSlowTaskfunc(void);
...
/* ISR IDs */ 
#define ISR_CAN0ERR ((ISRType)0)
#define ISR_INTP5 ((ISRType)1)
#define ISR_CAN0TRX ((ISRType)2)
...
#define ISR_TAUJ1I0 ((ISRType)7)
#define ISR_WDTA0 ((ISRType)8)
#define ISR_IIC0RI ((ISRType)9)
#define ISR_IIC0TI ((ISRType)10)
#define ISR_IIC0TEI ((ISRType)11)
#define ISR_IIC0EE ((ISRType)12)
#define ISR_ADCA0_INTSG1 ((ISRType)13)
#define ISR_CSIH1IR ((ISRType)14)
#define ISR_CSIH1IC ((ISRType)15)

#define ISR_UART0_Tx ((ISRType)16)
#define ISR_UART0_Rx ((ISRType)17)
#define ISR_UART0_Error ((ISRType)18)
#define ISR_OSTM0 ((ISRType)19)

#define ISR_CSIH0IR ((ISRType)20)
#define ISR_CSIH0IC ((ISRType)21)
#define ISR_CSIH0IRE ((ISRType)22)
#define ISR_CSIH1IRE ((ISRType)23)
#define ISR_TAUD0I6 ((ISRType)24)
#define ISR_TAUJ1I2 ((ISRType)25)

#define ISR_INTP6	((ISRType) 26)
#define ISR_TAUD0I2	((ISRType)27)
#define ISR_UART1_Tx ((ISRType)28)
#define ISR_UART1_Rx ((ISRType)29)
#define ISR_UART1_Error ((ISRType)30)
#define ISR_INTP3	((ISRType)31)
#define ISR_TAUB0I11 ((ISRType)32)
#define ISR_ADCA1_INTSG1 ((ISRType)33)

#define ISR_TAUB0I2 ((ISRType)34)
#define ISR_TAUB0I4 ((ISRType)35)
#define ISR_TAUB0I5 ((ISRType)36)
#define ISR_TAUB0I6 ((ISRType)37)
#define ISR_TAUB0I7 ((ISRType)38)
#define ISR_TAUB0I8 ((ISRType)39)
#define ISR_TAUB0I10 ((ISRType)40)
#define ISR_TAUB0I12 ((ISRType)41)
#define ISR_TAUB0I13 ((ISRType)42)
#define ISR_TAUB0I14 ((ISRType)43)
#define ISR_TAUB0I15 ((ISRType)44)


#define ISR_UART3_Tx ((ISRType)45)
#define ISR_UART3_Rx ((ISRType)46)
#define ISR_UART3_Error ((ISRType)47)

#define ISR_TAUD0I1 ((ISRType)48)
#define ISR_TAUJ0I1 ((ISRType)49)



#define ISR_CAN1ERR ((ISRType)50)
#define ISR_CAN1TRX ((ISRType)51)

#define ISR_TAUJ1I1 ((ISRType)52)

#define ISR_INTDMA0 ((ISRType)53)
#define ISR_INTDMA1 ((ISRType)54)
#define ISR_INTDMA2 ((ISRType)55)
#define ISR_INTDMA3 ((ISRType)56)
#define ISR_INTDMA4 ((ISRType)57)
#define ISR_INTDMA5 ((ISRType)58)
#define ISR_INTDMA6 ((ISRType)59)
#define ISR_INTDMA7 ((ISRType)60)
#define ISR_INTDMA8 ((ISRType)61)
#define ISR_INTDMA9 ((ISRType)62)
#define ISR_INTDMA10 ((ISRType)63)
#define ISR_INTDMA11 ((ISRType)64)
#define ISR_INTDMA12 ((ISRType)65)
#define ISR_INTDMA13 ((ISRType)66)
#define ISR_INTDMA14 ((ISRType)67)
#define ISR_INTDMA15 ((ISRType)68)
...
void ISR_TAUB0I11func(void);
 ...
 void ISR_TAUB0I2func(void);
 void ISR_TAUB0I4func(void);
 void ISR_TAUB0I5func(void);
 void ISR_TAUB0I6func(void);
 void ISR_TAUB0I7func(void);
 void ISR_TAUB0I8func(void);
 void ISR_TAUB0I10func(void);
 void ISR_TAUB0I12func(void);
 void ISR_TAUB0I13func(void);
 void ISR_TAUB0I14func(void);
 void ISR_TAUB0I15func(void);
...
#define UltraRadarFastEvt ((EventMaskType)(0x01))
#define UltraRadarSlowEvt ((EventMaskType)(0x01))
