...
#define osdUltraRadarFastTask_BOT osBottomOfStack(osTaskStack6)
#define osdUltraRadarFastTask_TOP osAssignStack(osTaskStack6)

#define osdUltraRadarSlowTask_BOT osBottomOfStack(osTaskStack7)
#define osdUltraRadarSlowTask_TOP osAssignStack(osTaskStack7)

#define osdResetTask_BOT osBottomOfStack(osTaskStack8)
#define osdResetTask_TOP osAssignStack(osTaskStack8)
...
#define osdISR_Level0_BOT osBottomOfStack(osIntStackLevel0_c0)
#define osdISR_Level0_TOP osAssignStack(osIntStackLevel0_c0)

#define osdISR_Level1_BOT osBottomOfStack(osIntStackLevel1_c0)
#define osdISR_Level1_TOP osAssignStack(osIntStackLevel1_c0)

#define osdISR_Level2_BOT osBottomOfStack(osIntStackLevel2_c0)
#define osdISR_Level2_TOP osAssignStack(osIntStackLevel2_c0)

#define osdISR_Level3_BOT osBottomOfStack(osIntStackLevel3_c0)
#define osdISR_Level3_TOP osAssignStack(osIntStackLevel3_c0)

#define osdISR_Level4_BOT osBottomOfStack(osIntStackLevel4_c0)
#define osdISR_Level4_TOP osAssignStack(osIntStackLevel4_c0)
 ...
 */
osqStack1 extern osqStack2 osStackDataType osqStack3 osIntStackLevel0_c0 [150]; /* PRQA S 0777 */ /* PRQA S 4152 */ 
#pragma ghs enddata
 ...
 * sequential number at the end (777).
 */
osqStack1 extern osqStack2 osStackDataType osqStack3 osIntStackLevel2_c0 [50];	//change to 1K 	 /* PRQA S 0777 */ /* PRQA S 4152 */ 
#pragma ghs enddata
 ...
 * sequential number at the end (777).
 */
osqStack1 extern osqStack2 osStackDataType osqStack3 osIntStackLevel3_c0 [150];	//change to 1K 	 /* PRQA S 0777 */ /* PRQA S 4152 */ 
#pragma ghs enddata
 ...
 * sequential number at the end (777).
 */
osqStack1 extern osqStack2 osStackDataType osqStack3 osIntStackLevel4_c0 [50];	//change to 1K 	 /* PRQA S 0777 */ /* PRQA S 4152 */ 
#pragma ghs enddata
 ...
 * sequential number at the end (777).
 */
osqStack1 extern osqStack2 osStackDataType osqStack3 osTaskStack0 [100];		//[75]; /* PRQA S 0777 */ /* PRQA S 4152 */ 
#pragma ghs enddata
 ...
 * sequential number at the end (777).
 */
osqStack1 extern osqStack2 osStackDataType osqStack3 osTaskStack1 [2048]; /* PRQA S 0777 */ /* PRQA S 4152 */ 
#pragma ghs enddata
 ...
 * sequential number at the end (777).
 */
osqStack1 extern osqStack2 osStackDataType osqStack3 osTaskStack2 [768]; /* PRQA S 0777 */ /* PRQA S 4152 */ 
#pragma ghs enddata
 ...
 * sequential number at the end (777).
 */
osqStack1 extern osqStack2 osStackDataType osqStack3 osTaskStack3 [768]; /* PRQA S 0777 */ /* PRQA S 4152 */ 
#pragma ghs enddata
 ...
 * sequential number at the end (777).
 */
osqStack1 extern osqStack2 osStackDataType osqStack3 osTaskStack4 [200]; /* PRQA S 0777 */ /* PRQA S 4152 */ 
#pragma ghs enddata
 ...
 * sequential number at the end (777).
 */
osqStack1 extern osqStack2 osStackDataType osqStack3 osTaskStack5 [100];		//[75]; /* PRQA S 0777 */ /* PRQA S 4152 */ 
#pragma ghs enddata
 ...
 * sequential number at the end (777).
 */
osqStack1 extern osqStack2 osStackDataType osqStack3 osTaskStack6 [800]; /* PRQA S 0777 */ /* PRQA S 4152 */ 
#pragma ghs enddata
 ...
 * sequential number at the end (777).
 */
osqStack1 extern osqStack2 osStackDataType osqStack3 osTaskStack7 [100]; /* PRQA S 0777 */ /* PRQA S 4152 */ 
#pragma ghs enddata
 ...
 * sequential number at the end (777).
 */
osqStack1 extern osqStack2 osStackDataType osqStack3 osTaskStack8 [75]; /* PRQA S 0777 */ /* PRQA S 4152 */ 
#pragma ghs enddata
