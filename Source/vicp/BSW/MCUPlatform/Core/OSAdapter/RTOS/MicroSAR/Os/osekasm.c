...
* ----------------------------------------------------------------------------
* 0.2    Jan 05,2017       ZhangJie           Delete test code for NMI
* ----------------------------------------------------------------------------
* 0.3    Jan 06,2017       ZhangJie           Recover NMI related function and add function discription
*-----------------------------------------------------------------------------*/
...
/*IC_RH850_F1K*/
  ...
  mov   ___ghs_rramend, r7     -- load end of local RAM
  mov   r0, r1
1:
  st.dw r0, 0[r6]
  addi  8, r6, r6
...
_osStartTrustedTask:
   ...
   mov  _osSysCallMissingTerminateTask, lp  -- lp = _osSysCallMissingTerminateTask -> prepare missing terminate error       
   #endif
   eiret                                    -- return from exception
#pragma endasm
