...
extern void  CaptureTestDriver_GetValueISR( U64 data);
...
#if (MCU_PIN >= PIN100)
	{TAU_CKx_PCLK_3, TAU_CKx_PCLK_0, TAU_CKx_PCLK_5, TAU_CKx_PCLK_10, 0},  /*taub0*/
#endif
#if (MCU_PIN == PIN176)
	{TAU_CKx_PCLK_4, TAU_CKx_PCLK_5, TAU_CKx_PCLK_5, TAU_CKx_PCLK_10, 0},  /*taub1*/
#endif   /**TAUD0_CH0 used CK2 as OSTimer, DO NOT CHANGE IT**/
	{TAU_CKx_PCLK_6, TAU_CKx_PCLK_0, TAU_CKx_PCLK_4, TAU_CKx_PCLK_4, 0},  /*tauD0*/
	{TAU_CKx_PCLK_5, TAU_CKx_PCLK_6, TAU_CKx_PCLK_5, TAU_CKx_PCLK_0, 0},  /*tauJ0*/
#if (MCU_PIN >= PIN100)
...
const Func_Param64_Proc tau_func_callback[TAU_U_MAX][TAU_CH_MAX]=
{
   ...
   /*TAUD0_U2*/
  {NULL, TAUD0I1_Timer_callback, NULL, NULL,
    NULL, NULL, NULL, NULL,
    NULL, NULL, NULL, NULL,
