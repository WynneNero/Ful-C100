...
* Equation:CPU clock=external OSC X(Nr/Mr)x(1/6)
* e.g external OSC,   CPU clock,  PLLC_Nr, PLLC_Mr,  
*       16mhz              80mhz        60            2       
*         8mhz              80mhz        60            1       
*       20mhz              80mhz        48            2       
*       24mhz              80mhz        40            2   
...
#define  CPUCLK_NORMAL_HZ    (120000000u)/*CPU clock:80MHZ*/

//#define CPUCLK_NORMAL_HZ (120000000u)/*CPU clock:80MHZ*/
#define PPLLCLK_NORMAL_HZ (80000000u)/*Peri PLL clock:80MHZ*/
...
#define	PERI1_CLKDOMAIN_HZ (PPLLCLK_NORMAL_HZ)
#define	PERI2_CLKDOMAIN_HZ (PPLLCLK_NORMAL_HZ /2)
...
/*Define PERI1 and PERI2 as CPUCLK2 in mcu run mode. Can not be changed */
#define	PERI1_CLKDOMAIN_HZ   (PPLLCLK_NORMAL_HZ/2)
#define	PERI2_CLKDOMAIN_HZ   (PPLLCLK_NORMAL_HZ/2)
