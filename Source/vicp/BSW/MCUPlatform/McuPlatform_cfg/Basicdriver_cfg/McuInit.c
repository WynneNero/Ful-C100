...
#endif
#define WDTNMIFC           (*(CPU_REG32  *)0xFFC00008u)
#ifdef XCP_DEBUG
extern void Ostm1_init(U32 pllclk_hz, U32  tick_per_sec, U8 opratMode, BOOL intEnble);/*uidq1158:for VX1000 32 bit free-runing cnt*/
extern void Ostm1_start(void);
#endif
/*============================================================================
Includes
============================================================================*/
...
{
#ifdef  XCP_DEBUG
   Ostm1_init(60000000,0x01,0x02,0x00);/*ostm1 init for VX1000 free-runing cnt*/
   Ostm1_start();
   VX1000If_Init();
