...
/****************************************ENG***************************************/
	...
	TIMER(OPEN_2F_CAMERA_PWR,open_2F_camera_pwr)
	...
	TIMER(OPEN_VEHICLE_DEAD_RECKONING, VehicleDeadReckoningSender)   //C080 new
	/***********USS TASK BELOW**************/
	//   TIMER(OPEN_ULTRA_RADAR_CYCLIC_TASK, UltraRadarCyclicTask10msEntry)
	//   TIMER(OPEN_APA_SLOT_SEARCHING, APASlotSearchingHandler)
	/***********USS TASK ABOVE**************/

	TIMER(DR_ISRESET_POLLING, DR_Reset_Handler)            //C080 new
	TIMER(DR_M4_INITREQUEST_ISFALSE, DRInitRequest_IsFalse)
	TIMER(APS_DR_SENDER, APS_DR_Sender)
