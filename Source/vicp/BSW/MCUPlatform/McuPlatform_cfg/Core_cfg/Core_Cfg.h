...
typedef enum E_OSAPI_TASKID
{
	...
	OSAPI_ULTRARADARFASTTASK,
	OSAPI_ULTRARADARSLOWTASK,
	OSAPI_TASKNUM
}OSAPI_TaskIDType;
...
typedef enum E_OSAPI_TASKPRIORITY
{
	...
	OSAPI_ULTRARADARFASTTASK_PRIO,
	OSAPI_ULTRARADARSLOWTASK_PRIO
}OSAPI_TaskPriType;
...
/*Fast alarm*/
#define OSALARM_FAST_ALARM_CARE_MSK 5u  /* 5ms	n * OSAPI_SYSTEM_CLOCK*/
/*#define OSALARM_FAST_ALARM_VAL 5		0x01u*/

/*Slow alarm*/
/*#define OSALARM_SLOW_ALARM_CARE_MSK 25		0x0Au 25ms*/
#define OSALARM_SLOW_ALARM_VAL 25u	/* 25ms*/

#define OSALARM_TIMER_ISR 	1u

/*OS timer config*/
#define OSAPI_SYSTEM_CLOCK 	10u   /*	1.0ms          1u   1ms*/
