...
#define SetBit(Var,Place) (Var|=(unsigned char)((1<<(Place%8))))
#define ClrBit(Var,Place) (Var&=(unsigned char)((1<<(Place%8))^255))

#define GetBit(Var,Place) ((Var& (1<<(Place%8)))==0?0:1)
#define CplBit(Var,Place) (Var^=(1<<(Place%8)))
#define LSB(_WORD)		  (unsigned char)(_WORD)
#define MSB(_WORD)		  (unsigned char)(_WORD>>8)
#define WORD(MSB,LSB)	  (unsigned int)(((unsigned int) MSB << 8) + LSB)
