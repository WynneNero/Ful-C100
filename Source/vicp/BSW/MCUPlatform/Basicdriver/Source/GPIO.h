...
#define  APORT0_REG_APM(n)      (*(CPU_REG16 *)(PORT_REG_BASEADD + 0x03C8 + 4 *(n))) 
#define  APORT0_REG_APIBC(n)   (*(CPU_REG16 *)(PORT_REG_BASEADD + 0x40C8 + 4 *(n)))  
#define  APORT0_REG_APBDC(n)  (*(CPU_REG16 *)(PORT_REG_BASEADD + 0x41C8 + 4 *(n))) 
#define  APORT0_REG_P(n)       (*(CPU_REG16 *)(PORT_REG_BASEADD + 0x00C8 + 4 *(n))) 
#define  APORT0_REG_PPR(n)     (*(CPU_REG16 *)(PORT_REG_BASEADD + 0x02C8 + 4 *(n)))
  
#define  APORT1_REG_APM(n)      (*(CPU_REG16 *)((PORT_REG_BASEADD) + 0x03CCu + (4u *(n)))) 
#define  APORT1_REG_APIBC(n)   (*(CPU_REG16 *)((PORT_REG_BASEADD) + 0x40CCu + (4u *(n))))  
#define  APORT1_REG_APBDC(n)  (*(CPU_REG16 *)((PORT_REG_BASEADD) + 0x41CCu + (4u *(n))))
#define  APORT1_REG_P(n)       (*(CPU_REG16 *)((PORT_REG_BASEADD) + 0x00CCu + (4u *(n))))
#define  APORT1_REG_PPR(n)     (*(CPU_REG16 *)((PORT_REG_BASEADD) + 0x02CCu + (4u *(n)))) 
