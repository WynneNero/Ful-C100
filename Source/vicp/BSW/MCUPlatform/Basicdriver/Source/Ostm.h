...
#define IsOSTM1_ENBLED()    (OSTM1_REG_TE==0x01u) 

/* ------------------- OS TM0  REGISTERS ----------------- */
#ifdef IC_RH850_F1K	//uidq1158
#define OSTM0_REG_BASEADD	 ((CPU_INT32U)(0xFFD70000u))
#define OSTM1_REG_BASEADD	 ((CPU_INT32U)(0xFFD70100u))
...
/*  OSTM1  */
#define OSTM1_REG_CMP      (*(CPU_REG32 *)((OSTM1_REG_BASEADD) + 0x0000u))
#define OSTM1_REG_CNT      (*(CPU_REG32 *)((OSTM1_REG_BASEADD) + 0x0004u))
#define OSTM1_REG_TE  		 (*(CPU_REG32 *)((OSTM1_REG_BASEADD) + 0x0010u))
#define OSTM1_REG_TS  		 (*(CPU_REG32 *)((OSTM1_REG_BASEADD) + 0x0014u))
#define OSTM1_REG_TT  		 (*(CPU_REG32 *)((OSTM1_REG_BASEADD) + 0x0018u))
#define OSTM1_REG_CTL      (*(CPU_REG32 *)((OSTM1_REG_BASEADD) + 0x0020u))
#define OSTM1_REG_EMU      (*(CPU_REG32 *)((OSTM1_REG_BASEADD) + 0x0024u))
