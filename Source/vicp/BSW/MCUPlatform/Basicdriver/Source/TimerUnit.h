...
extern BOOL TAU_Capture_Init (TAU_UNIT un, TAU_CHANNEL chm, U8 edge);
extern BOOL TAU_Timer_Init(TAU_UNIT un, TAU_CHANNEL chm, U32 MS_count, BOOL isOut, BOOL isLoop);
