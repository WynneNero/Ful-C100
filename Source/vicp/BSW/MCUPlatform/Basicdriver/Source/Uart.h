...
#define PLL_FREQ_HZ (PPLLCLK_NORMAL_HZ)
#define UART_CLOCK_HZ (PLL_FREQ_HZ/2u)
#define UART_BAUDRATE(x) (UART_CLOCK_HZ/ (U32)((x)*6u) - 1u)

/* ------------------- Uart REGISTERS ----------------- */
#define  UART_REG_URTE0BASEADD                    ( (CPU_INT32U )0xFFCE2000u)
#define  UART_REG_URTE1BASEADD                    ( (CPU_INT32U )0xFFCE2040u)
#define  UART_REG_URTE2BASEADD                    ( (CPU_INT32U )0xFFCE2080u)
#define  UART_REG_URTE3BASEADD                    ( (CPU_INT32U )0xFFCE20C0u)
#define  UART_REG_URTE4BASEADD                    ( (CPU_INT32U )0xFFCE2100u)
#define  UART_REG_URTE5BASEADD                    ( (CPU_INT32U )0xFFCE2140u)
