...
#define DELAT_RESET_MCU_TIMES  4
...
U8 uIoControlAVSViewSta;
U8 uIoControlAVSDynamicPGSSta;
...
#define DIAG_WAIT_J6_RESP_TIME 60
...
//$85
 ...
 //$22
 void ApplDescReadBootSoftwareIdentification_AddOn(DescMsgContext* pMsgContext);		 //DES_22_F183_READ_SUPPLIER_ECU_BOOT_SOFTWARE_IDENTIFICATION,
 ...
 void ApplDescReadDidIoControlAVSView_Status__AddOn(DescMsgContext* pMsgContext);//DES_22_C0C0_READ_Did2FCONTROL_AVS_VIEW_CHANGE,
  void ApplDescReadDidInstallation_Status__AddOn(DescMsgContext* pMsgContext);//DES_22_0107_READ_DidInstallation_Status,
 ...
 //$2F
 void ApplDescReturnControlToECU_AVSDynamicPGS_Status_AddOn(DescMsgContext* pMsgContext);
 void ApplDescControl_AVSDynamicPGS_Status_AddOn(DescMsgContext* pMsgContext);
 ...
 void ApplDescResultEnterEOLView_AddOn(DescMsgContext* pMsgContext);
  void ApplDescStartInstallation_AddOn(DescMsgContext* pMsgContext);
 void ApplDescStartCalibration_AddOn(DescMsgContext* pMsgContext);
 void ApplDescStopCalibration_AddOn(DescMsgContext* pMsgContext);
...
DiagHandler CanDiagHandler[DESC_MAX_TYPE]=
{
 ...
 /* $22:Read by data identifier */	
	ApplDescReadBootSoftwareIdentification_AddOn,//DES_22_F183_READ_SUPPLIER_ECU_BOOT_SOFTWARE_IDENTIFICATION
	...
	ApplDescReadDidAVS_View_Change_Status_AddOn, //DES_22_2B10_READ_DidAVS_View_Change_Status,
	...
	ApplDescReadDidIoControlAVSView_Status__AddOn,//DES_22_C0C0_READ_Did2FCONTROL_AVS_VIEW_CHANGE,
	ApplDescReadDidInstallation_Status__AddOn,//DES_22_0107_READ_DidInstallation_Status
	...
	/* $2F:routine */
//	ApplDescReturnControlToECU_AVSDynamicPGS_Status_AddOn, //DESC_2F_C0C1_00_ControlToECU_AVS_DYNAMICPGS_STATUS
//	ApplDescControl_AVSDynamicPGS_Status_AddOn, //DESC_2F_C0C1_03_CONTROL_AVS_DYNAMICPGS_STATUS
	...
	ApplDescResultEnterEOLView_AddOn,//DESC_3103_E100_REQUEST_ROUTINE_RESULT_ENTER_EOL_VIEW
    ApplDescStartInstallation_AddOn,//DESC_3101_0205_START_INSTALLATION
	ApplDescStartCalibration_AddOn, //DESC_3101_E101_START_CALIBRATION
//	ApplDescStopCalibration_AddOn,//DESC_3102_E101_STOP_CALIBRATION
...
//			if((ControlState == 0)||(ControlState > 0x07))
//			{
//				NRC_occured = TRUE;
//			}
//			break;
...
//		case DESC_85_02_CONTROL_DTC_SETTING_OFF:
		...
		case DESC_3101_0205_START_INSTALLATION:
   		case DESC_3101_E101_START_CALIBRATION:
//		case DESC_3102_E101_STOP_CALIBRATION:
...
void ClearDtcFidDataRecord(void)
{
	EED_LockDataBlock(EED_nDTCFidData);
    _memset(EED_CANDTC_FID_DATA,0,DTC_BIT30);
    EED_UnlockDataBlock(EED_nDTCFidData);

	EED_LockDataBlock(EED_nDTCFidData1);
    _memset(EED_CANDTC_FID_DATA1,0,DTC_BIT30);
    EED_UnlockDataBlock(EED_nDTCFidData1);

	EED_LockDataBlock(EED_nDTCFidData2);
    _memset(EED_CANDTC_FID_DATA2,0,DTC_CODE_MAX_NUM1);
    EED_UnlockDataBlock(EED_nDTCFidData2);
}

void ClearDtcSnapshotDataRecord(void)
{
	EED_LockDataBlock(EED_nDTCSnapshotRecord);
	_memset(EED_CANDTC_DTCSNAPSHOTDATA,0,(7 * DTC_CODE_MAX_NUM)); 
...
void ApplDescReadBootSoftwareIdentification_AddOn(DescMsgContext* pMsgContext)		 //DES_22_F183_READ_SUPPLIER_ECU_BOOT_SOFTWARE_IDENTIFICATION,
{
	...
	if(FALSE == can_diag_svc_negative_response_check(DES_22_F183_READ_SUPPLIER_ECU_BOOT_SOFTWARE_IDENTIFICATION, pMsgContext))
	{
...
void ApplDescReadDidRepair_Shop_Code_and_or_Tester_Serial_Number_AddOn(DescMsgContext* pMsgContext)//DES_22_F198_READ_REPAIR_SHOP_CODE_AND_OR_TESTER_SERIAL_NUMBER,
{
	...
	{  		
		...
		RET = FDdriver_BlackCheck(F198_STORE_ADDRESS, 3);
		if(RET == TRUE)
		{
			/* not written */
			_memcpy(pMsgContext->resData, arg_nowrite, pMsgContext->resDataLen);
...
void ApplDescReadDidSystem_Configuration_1_AddOn(DescMsgContext* pMsgContext)	 //DES_22_F1A1_READ_SYSTEM_CONFIGURATION_1,
{
	...
	{  
		...
		RET = FDdriver_BlackCheck(F1A1_STORE_ADDRESS, 1);
		if(RET == TRUE)
		{
			/* not written */
			_memcpy(pMsgContext->resData, arg_nowrite, pMsgContext->resDataLen);
		...
		{
			/* is written */
			RET = FDLDriver_Read(F1A1_STORE_ADDRESS,arg, 1);
			_memcpy(pMsgContext->resData, arg, pMsgContext->resDataLen);
			if(0 == RET)
            {
                /* Read Error, need retry! */
...
void ApplDescReadDidVehicleSpeed_Value__AddOn(DescMsgContext* pMsgContext)//DES_22_0100_READ_DidVehicleSpeedValue
{
	...
	{  
		pMsgContext->resDataLen = 2;
		pMsgContext->resData[0] = Signal_Snapshot_Data.Snapshot0100_VehicleSpeed>>8;
		pMsgContext->resData[1] = Signal_Snapshot_Data.Snapshot0100_VehicleSpeed&0xFF;
	 }
	SendDiagResponse(E_POSITIVE_DIAG_RESPONSE);
}
...
void ApplDescReadDidOdometer_Value__AddOn(DescMsgContext* pMsgContext)  //DES_22_0101_READ_DidOdometerValue
{
	...
	{  
		pMsgContext->resDataLen = 4;
		pMsgContext->resData[0] = (Signal_Snapshot_Data.Snapshot0101_Odometer >> 24)& 0x000000FF;
		pMsgContext->resData[1] = (Signal_Snapshot_Data.Snapshot0101_Odometer >> 16)& 0x000000FF;
		pMsgContext->resData[2] = (Signal_Snapshot_Data.Snapshot0101_Odometer >> 8)& 0x000000FF;
		pMsgContext->resData[3] = Signal_Snapshot_Data.Snapshot0101_Odometer & 0x000000FF;
	 }
	SendDiagResponse(E_POSITIVE_DIAG_RESPONSE);
}
...
void ApplDescReadDidIoControlAVSView_Status__AddOn(DescMsgContext* pMsgContext)  //DES_22_C0C0_READ_Did2FCONTROL_AVS_VIEW_CHANGE,
{
	if(FALSE == can_diag_svc_negative_response_check(DES_22_C0C0_READ_Did2FCONTROL_AVS_VIEW_CHANGE, pMsgContext))
	{  
		pMsgContext->resDataLen = 1;
		pMsgContext->resData[0] = uIoControlAVSViewSta;
	 }
	SendDiagResponse(E_POSITIVE_DIAG_RESPONSE);
}
...
void ApplDescReadDidInstallation_Status__AddOn(DescMsgContext* pMsgContext)  //DES_22_0107_READ_DidInstallation_Status,
{
	if(FALSE == can_diag_svc_negative_response_check(DES_22_0107_READ_DidInstallation_Status, pMsgContext))
	{  
		pMsgContext->resDataLen = 1;
		pMsgContext->resData[0] = uIoControlAVSViewSta;
	 }
...
void ApplDescReadDidSupplyVoltage_Value__AddOn(DescMsgContext* pMsgContext) //DES_22_0102_READ_DidSupplyVoltageValue,
{
	...
	{  
		pMsgContext->resDataLen = 1;
		pMsgContext->resData[0] = Signal_Snapshot_Data.Snapshot0102_SupplyVoltage;		
	 }
	SendDiagResponse(E_POSITIVE_DIAG_RESPONSE);
}
...
void ApplDescWriteDidSystem_Configuration_1_AddOn(DescMsgContext* pMsgContext)		 //DES_22_F1A1_WRITE_SYSTEM_CONFIGURATION_1,
{
	...
	{  
		...
		RET = FDLDriver_Write(F1A1_STORE_ADDRESS,arg,1);
		if(ERR_OK != RET)
        {
            /* Write Error, need retry! */
            EepWriteControl.uEepRetryAddr = F1A1_STORE_ADDRESS;
            EepWriteControl.uEepRetryWordNum = 1;
            EepWriteControl.uEepRetryByte = 2;
            DescStartRepeatedServiceCall(&CAN_EEP_RewriteHandler);
        }	
		else
        {
...
void ApplDescReturnControlToECU_AVSDynamicPGS_Status_AddOn(DescMsgContext* pMsgContext)
{
//	if(FALSE == can_diag_svc_negative_response_check(DESC_2F_C0C1_00_ControlToECU_AVS_DYNAMICPGS_STATUS, pMsgContext))
//	{  
//		IoControl.bReqSent = TRUE;
//		IoControl.bControlParameterType = RETURNCONTROL_TYPE;
//		IoControl.bControlType  = DYNAMICPGS_CONTROL;
//		IoControl.bControlState	= 0x04;
//		IoControl.uRecvDatatime = 0;
//		IoControl.bBeenSend = TRUE;
//		uIoControlAVSDynamicPGSSta = 0;
//		DescStartRepeatedServiceCall(&CAN_Navi_Response);
//	}
//	else
//	{
...
//void ApplDescControl_AVSDynamicPGS_Status_AddOn(DescMsgContext* pMsgContext)
//{
//	if(FALSE == can_diag_svc_negative_response_check(DESC_2F_C0C1_03_CONTROL_AVS_DYNAMICPGS_STATUS, pMsgContext))
//	{
//		IoControl.bReqSent = TRUE;
...
void ApplDescReturnControlToECU_AVSView_AddOn(DescMsgContext* pMsgContext)
{
	...
	{  
		if(uAVSViewMode == 0x01)   //The request parameter is same witch current status of avs view, so return positive response.
		{
			if(uAVSSt)
			{
				SendDiagResponse(E_POSITIVE_DIAG_RESPONSE);
		...
		else
		{
			...
			IoControl.bControlState	= 0x01;
			IoControl.uRecvDatatime = 0;
			IoControl.bBeenSend = TRUE;
			uIoControlAVSViewSta = 1;
			DescStartRepeatedServiceCall(&CAN_Navi_Response);
		}
	}
	else
...
void ApplDescControl_AVSView_AddOn(DescMsgContext* pMsgContext)
{
	...
	{
		if(uAVSViewMode == pMsgContext->reqData[0])   //The request parameter is same witch current status of avs view, so return positive response.
		{
			if(uAVSSt)
			{
				pMsgContext->resDataLen = 1;
...
void ApplDescStartInstallation_AddOn(DescMsgContext* pMsgContext)
{
	...
	if(FALSE == can_diag_svc_negative_response_check(DESC_3101_0205_START_INSTALLATION, pMsgContext))
	 {	
...
//	 	SocManager_SendMsg(LQ_CMD,TYPE_EVENT, MCU_NOTIFY_SOC_START_TO_CELIBRATION,1,mStartEnterCalibration);

//	 	app_31ServiceNRC78Flag = 0;
//		DescForceRcrRpResponse();
//		CanDiag_SetDelayTime();
//		Calibration_RetryCnt = 0;
//		DescStartRepeatedServiceCall(&CanResponseStartCalibration);
...
//	 	app_31ServiceNRC78Flag = 0;
//		Calibration_RetryCnt = 0;
		SocManager_SendMsg(LQ_CMD,TYPE_EVENT,MCU_NOTIFY_ENTER_CALIBRATION_MODE,1,mEnterCalibration);
//		DescForceRcrRpResponse();
//		CanDiag_SetDelayTime();
//		DescStartRepeatedServiceCall(&CanResponseEnterOfflineCalibrationResult);
...
void ApplDescResultEnterEOLView_AddOn(DescMsgContext* pMsgContext)
{
	...
	{
		pMsgContext->resDataLen = 2;
		pMsgContext->resData[0]  = (uAVSViewMode == CAN_FACTROY_MODE)? 1 : 0;
		pMsgContext->resData[1]  = (uAVSViewMode == CAN_FACTROY_MODE)? HMI_VIEW_EOL : HMI_VIEW_MAIN_SCREEN;
		SendDiagResponse(E_POSITIVE_DIAG_RESPONSE);
...
//	U8 mStartEnterCalibration = 0;
//	U8 Calibration_default = 0x1;
//	if(FALSE == can_diag_svc_negative_response_check(DESC_3102_E101_STOP_CALIBRATION, pMsgContext))
//	 {	
		...
		if(IoControl.bRespReceived == TRUE)
		{
			if(IoControl.bControlType == IoControl.bRespControlType)
			{
				...
				if(IoControl.bControlParameterType == CONTROL_TYPE)
				{
					...
					if(IoControl.bControlType == DYNAMICPGS_CONTROL)
					{
						uIoControlAVSDynamicPGSSta = IoControl.bRespControlState;
					}
					else if(IoControl.bControlType == VIEW_CONTROL)
					{
						uIoControlAVSViewSta = IoControl.bRespControlState;
						uAVSViewMode = IoControl.bRespControlState;
					}
				}				
				SendDiagResponse(E_POSITIVE_DIAG_RESPONSE);
				_memset(&IoControl,0,sizeof(E_IO_CONTROL_STRUCT));
...
void CanDiag_recvnavimsg_handler(U16 commandid, U8* data)
{
	...
	if(IoControl.bReqSent == TRUE)
	{
		switch (commandid)
		{
			...
			case CPU_NOTIFY_M3_PCS_SingleViewInd:
				IoControl.bRespReceived = TRUE;
