...
extern void  CanDiag_recvnavimsg_handler(U16 commandid, U8* data);
//extern void CanDiagService_recvnavimsg_handler(U16 commandid, U8* data);
...
extern void ClearDtcExtendDataRecord(void);
extern void ClearDtcFidDataRecord(void);
extern void ClearDtcSnapshotDataRecord(void);

extern U8 uAVSCarModelColor;
extern U8 uAVSViewMode;
extern U8 uAVSCalibrationSta;
extern U8 ManualcalibProcess;
