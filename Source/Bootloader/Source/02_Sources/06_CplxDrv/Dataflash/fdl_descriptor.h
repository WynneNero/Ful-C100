 ...
 * Mod. Date     : $Date: 2013/09/27 18:01:39MESZ $
 ...
 *********************************************************************************************************************/
     ...
     *   - ID verification -
     *****************************************************************************************************************/
    /* The Flash programming will be enabled after verification of the authentication ID. This ID is checked during 
       library initialization, wrong ID will result in an protection error */
    #define AUTHENTICATION_ID       { 0xFFFFFFFF, \
                                      0xFFFFFFFF, \
                                      0xFFFFFFFF, \
                                      0xFFFFFFFF }                  /**< 16Byte authentication ID */
    ...
    #define EEL_VIRTUALBLOCKSIZE   32u   // Each block with 64bytes, so bytes of VIRTUALBLOCK is 2K,equal to 32u * 64                
/* The previous  dataflash with (31u * EEL_VIRTUALBLOCKSIZE) for fdl lib,the last 2k space for ICUS key.  */
    #define FDL_POOL_SIZE           (31u * EEL_VIRTUALBLOCKSIZE)    /**<  Number of Data Flash blocks, accessible by 
