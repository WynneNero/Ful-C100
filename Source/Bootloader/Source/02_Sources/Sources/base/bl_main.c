...
const bl_u8_t BootLoaderConstantDID[2][16] = {\
     {'C','2','3','5','-','F','B','L','.','0','5',0x00,0x00,0x00,0x00,0x00},
     {' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' '}
};
...
void initProgrammingCounter(void);
 /**************************************************************************//**
 *
...
*  Returns     : void
***********************************************************************/
void delay_ms(U64 period)
{
#if 1
    U64 i;
  	//U64 cmd_period = (U64)period * 0x2710u;

    for(i = 0x00u; i < period ; i++)
    {
		tm_delay_us(1000);
    }
#endif
