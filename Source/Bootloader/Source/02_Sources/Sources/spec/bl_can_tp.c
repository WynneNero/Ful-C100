 ...
 *      05.01.02 | 14/04/2015 | mingqing.tang    | N/A | Boot050004
 *
 *****************************************************************************/
#include "bl_common.h"
#include "bl_rte.h"
...
static bl_u8_t _Cantp_GetSTMinFromFC(bl_u8_t st)
{
    ...
    else
    {
        ...
        retSTMin = st + 1;
#else
        retSTMin = ((st + 1) / CANTP_SCHEDULE_PERIOD) + 1;
#endif
...
//                tmpSt = CANTP_GET_FC_STMIN(pci,buffer) + 1;
    ...
    else
    {
        if (channel->bs != 0)
        {
            ...
            else
            {
                ...
                CANTP_SET_TIMER(channel,(channel->chnCfg->timerA + channel->st));
