...
/***********************************************************************
*  Name        : uP24G_On_Pulse
*  Description : generate the pulse       
*  Parameter   : None
*  Returns     : None
***********************************************************************/
void uP24G_On_Pulse(void)
{
	GPIO_SetOutMode(GPIO_PORT_10, GPIO_PIN_4, E_NO_MODE, E_HIGH_40MHZ);
	
    GPIO_Out_Write(GPIO_PORT_10, GPIO_PIN_4, 0);/*P10_4 set low more than 1s,At least 1s low and then released for ON/OFF*/
	delay_ms(1500);
    GPIO_Out_Write(GPIO_PORT_10, GPIO_PIN_4, 1);/*P10_4 set high,When Power on:1s<t<2s*/
    delay_ms(1500);
    GPIO_Out_Write(GPIO_PORT_10, GPIO_PIN_4, 0);/*P10_4 set low*/
	delay_ms(4000);		/*delay 4s*/
}

/***********************************************************************
*  Name        : uP24G_Off_Pulse
*  Description : generate the pulse for shun down      
*  Parameter   : None
*  Returns     : None
***********************************************************************/
void uP24G_Off_Pulse(void)
{
	GPIO_SetOutMode(GPIO_PORT_10, GPIO_PIN_4, E_NO_MODE, E_HIGH_40MHZ);
	
    GPIO_Out_Write(GPIO_PORT_10, GPIO_PIN_4, 0);/*P10_4 set low more than 1s,At least 1s low and then released for ON/OFF*/
    delay_ms(1500);
    GPIO_Out_Write(GPIO_PORT_10, GPIO_PIN_4, 1);/*P10_4 set high,When Power off:t<0.2s*/
    delay_ms(150);
    GPIO_Out_Write(GPIO_PORT_10, GPIO_PIN_4, 0);/*P10_4 set low*/
}
...
//	bOpen = FALSE;
//#endif
    GPIO_SetOutMode(GPIO_PORT_0, GPIO_PIN_4, E_PUSH_PULL, E_HIGH_40MHZ);	//CRQ OUTPUT  qyf
...
//	GPIO_SetInMode(AP_PORT_0, GPIO_PIN_D, E_NO_MODE, FALSE);
//
//    if(APPORT_In_Read(AP_PORT_0, GPIO_PIN_D))
//    {
//    	GPIO_SetOutMode(GPIO_PORT_10, GPIO_PIN_4, E_NO_MODE, E_HIGH_40MHZ);
//    	GPIO_Out_Write(GPIO_PORT_10, GPIO_PIN_4, 0);
//		delay_ms(1);
//    	uP24G_PWR_EN_Off();
//		delay_ms(1000);
//   	uP24G_PWR_EN_On(); 
...
///TODO:SQJ
    #ifdef TEST_INT
        GPIO_Out_Write (GPIO_PORT_10,GPIO_PIN_9,TRUE);
     #endif
