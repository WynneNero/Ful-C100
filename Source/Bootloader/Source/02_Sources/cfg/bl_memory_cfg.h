...
#define MEM_MEMORY_0_SIZE           (0x00002C00UL)//(0x00002A00UL)
...
#define MEM_MEMORY_1_TYPE           (MEM_MEMORY_TYPE_FLASH)
#else
...
#define MEM_MEMORY_1_SIZE           (0x00200000UL)			// 2048k code flash
...
#define MEM_MEMORY_2_SIZE           (0x00010000UL)		// 64K
