 ...
 *      05.01.01 | 14/03/2017 | Jie.Zhang            | N/A | Change fcl erase time delay.
******************************************************************************/
...
*/
#define FLASHIF_SECTOR_ERASETIME            (70)  /*unit ms*/
#define FLASHIF_PAGE_WRITETIME              (20)   /*unit ms*/
/* the max access time ,when time out the hiboot have to send reponse to pc */
#define FLASHIF_ACCESS_TIMELIMITE          (1000UL)  //(2500UL) /*unit ms*/
...
//WYJ
//#define FLASHIF_BLOCK0_STARTADDRESS         (0x0000C000UL)
//#define FLASHIF_BLOCK0_TOTAL_SIZE           (0x00004000UL)
//#define FLASHIF_BLOCK0_SECTOR_SIZE          (0x00002000UL)	// 8K
//#define FLASHIF_BLOCK0_PAGE_SIZE            (256)

/* config block 0 parameter - 0x10000-0x17FFF */
//#define FLASHIF_BLOCK1_STARTADDRESS         (0x00010000UL)
//#define FLASHIF_BLOCK1_TOTAL_SIZE           (0x00050000UL)
//#define FLASHIF_BLOCK1_SECTOR_SIZE          (0x00008000UL)	// 32K
...
#define FLASHIF_BLOCK0_STARTADDRESS         (0x00018000UL)
#define FLASHIF_BLOCK0_TOTAL_SIZE           (0x001E8000UL)
#define FLASHIF_BLOCK0_SECTOR_SIZE          (0x00008000UL)	// 32K
#define FLASHIF_BLOCK0_PAGE_SIZE            (256)

/* config block 0 parameter - 0x10000-0x17FFF */
#define FLASHIF_BLOCK2_STARTADDRESS         (0x020000UL)
#define FLASHIF_BLOCK2_TOTAL_SIZE           (0x020000UL)
#define FLASHIF_BLOCK2_SECTOR_SIZE          (0x020000UL)	// 128K
