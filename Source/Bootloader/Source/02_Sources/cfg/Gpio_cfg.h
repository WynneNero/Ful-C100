...
#define  OPEN_SOC_POWER()  do{GPIO_Out_Write(GPIO_PORT_10,GPIO_PIN_2,TRUE);\
							 ...
							 GPIO_Out_Write(GPIO_PORT_1,GPIO_PIN_A,TRUE);\
							 GPIO_SetOutMode (GPIO_PORT_1,GPIO_PIN_A, E_NO_MODE, E_HIGH_40MHZ);\
							 GPIO_Out_Write(GPIO_PORT_1,GPIO_PIN_9,TRUE);\
							 GPIO_SetOutMode (GPIO_PORT_1,GPIO_PIN_9, E_NO_MODE, E_HIGH_40MHZ);\
                           				 }while(0)
