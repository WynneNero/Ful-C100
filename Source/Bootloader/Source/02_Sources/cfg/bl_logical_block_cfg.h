...
#define LBM_LB0_WRITE_MASK          RTE_SYSFLAG_ERASE_BLOCK //RTE_SYSFLAG_WRITE_DATA 
#define LBM_LB0_ERASE_MASK          (0x00000000UL)
#define LBM_LB0_VERIFY_MASK         (0x00000000UL)
#define LBM_LB0_ADDRESS             (0x00018000UL)  //(0x00020000UL)  	// (0x0000C000UL)
#define LBM_LB0_SIZE                (0x001E8000UL)  // limit size:(2048 - 96)KB
...
#define LBM_LB1_ADDRESS             (0xFEDFC000UL)//(0xFEBE0000UL)	//
#define LBM_LB1_SIZE                (0x00002800UL)//(0x000027EEUL)//(0x00002A00UL)	/*0x00002900UL, modify this for test,160515*/
