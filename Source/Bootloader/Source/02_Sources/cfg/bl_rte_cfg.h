...
#endif
#ifdef OPEN_SPI_OPTION
//#define RTE_COMIF_OPS_INIT              (&SocInit)
//#define RTE_COMIF_OPS_DEINIT            (&SocDeInit)
//#define RTE_COMIF_OPS_READ              (NULL)
//#define RTE_COMIF_OPS_WRITE             (NULL)
//#define RTE_COMIF_OPS_ISSUCCWRITE       (NULL)
//#define RTE_REPROGRAM_PROCESS           (NULL)
//#define RTE_RESET_PROCESS               (NULL)
//#define RTE_STAYINBOOT_PROCESS          (NULL)
#endif
/*****************************************************************************
 *  Type Declarations
 *****************************************************************************/
