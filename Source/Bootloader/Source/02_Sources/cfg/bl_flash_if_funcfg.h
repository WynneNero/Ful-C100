...
#define FLASHIF_DRIVER_STARTADDRESS         (0xfedfC000UL)//(0xFEBE0000UL) //(0xFEDE0000UL)	 
#define FLASHIF_DRIVER_MAGIC_VALUE          (0x58455031UL)
#define FLASHIF_DRIVER_VERSION_VALUE        (0x00010300UL)

#define FLASHIF_NUMBER_OF_BLOCK             (2u)	//(1u)
