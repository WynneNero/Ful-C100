...
typedef enum _tag_Return
{
    ...
    /** A error code, named '07', is used by user.*/
    BL_ERR_USER_CODE_08 = 107,
    /** A error code, named '04', is used by user.*/
    BL_ERR_USER_CODE_09 = 108,
    /** A error code, named '05', is used by user.*/
    BL_ERR_USER_CODE_10 = 109,
    /** A error code, named '06', is used by user.*/
    BL_ERR_USER_CODE_11 = 110,
    /** A error code, named '07', is used by user.*/
    BL_ERR_USER_CODE_12 = 111,	
    /** A error code, named '07', is used by user.*/
    BL_ERR_USER_CODE_13 = 112,
    /** A error code, named '07', is used by user.*/
    BL_ERR_USER_CODE_14 = 113,
    /** A error code, named '06', is used by user.*/
    BL_ERR_USER_CODE_15 = 114,
    /** A error code, named '07', is used by user.*/
    BL_ERR_CHECKSUM_ERROR = 115,	
    /** A error code, named '07', is used by user.*/
    BL_ERR_VALID_ERROR = 116	
