...
#define RTE_SYSFLAG_CHECK_PROPCDT       (0x00000040UL)
...
#define RTE_EVENT_TYPE_SYSTEM_WAIT      (0x0004u)
...
#define RequestDownload				 (0x1)
#define TransferData				 (0x2)
#define RequestTransferExit			 (0x4)
#define EraseApplicationMemory 		 (0x8)
#define CheckProgrammingChecksum     (0x10)
#define CheckSoftwareProgramValidation (0x20)

#define FlashDriverAddr (0xFEDFC000UL)
#define McuappAddr      (0x18000)
#define SocappAddr      (0x1000C0)
...
typedef struct _tag_ProgrammingStep bl_ProgrammingStep_t ;
...
struct _tag_ProgrammingStep
{
	bl_u8_t flash_programming_process_step; // bit0 34 , bit1 36  bit2 37 bit3 erase mcu 
	bl_u16_t mcu_programming_process_step; // bit0 34 , bit1 36  bit2 37 bit3 erase  bit4 checksum
	bl_u8_t soc_programming_process_step; // bit0 34 , bit1 36  bit2 37 bit3 erase bi4 checksum
};
