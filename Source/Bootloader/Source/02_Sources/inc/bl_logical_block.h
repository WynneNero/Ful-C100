...
#define LBM_COUNTER_MAX_SIZE        (5)

#define LBM_ERR_UPDATED_ID          BL_ERR_USER_CODE_01
...
extern bl_Return_t Lbm_SaveStatus(bl_u16_t id);
...
/* To clear flash driver block status */
extern void Lbm_Clear_FlashDriver_Status(void);
