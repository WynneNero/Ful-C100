...
extern bl_ResponseCode_t Adpt_UdsCallBackWriteEcuPartNum(bl_BufferSize_t size,
                                                     bl_Buffer_t *buffer,
                                                     bl_BufferSize_t *respSize);
 /** \brief Callback of writting application fingerprint.*/
 extern bl_ResponseCode_t Adpt_UdsCallBackWriteFingerprintF184(bl_BufferSize_t size,
															  bl_Buffer_t *buffer,
															  bl_BufferSize_t *respSize);
...
extern bl_ResponseCode_t Adpt_UdsCallBackReadBootSoftwareId(bl_BufferSize_t size,
                                       bl_Buffer_t *buffer,
                                       bl_BufferSize_t *respSize);
extern bl_ResponseCode_t Adpt_UdsCallBackReadAppFingerprint(bl_BufferSize_t size,
												bl_Buffer_t *buffer,
												bl_BufferSize_t *respSize);
extern bl_ResponseCode_t Adpt_UdsCallBackReadDCID(bl_BufferSize_t size,
                                       bl_Buffer_t *buffer,
                                       bl_BufferSize_t *respSize);
extern bl_ResponseCode_t Adpt_UdsCallBackReadGacSparePN(bl_BufferSize_t size,
                                       bl_Buffer_t *buffer,
                                       bl_BufferSize_t *respSize);
...
extern bl_ResponseCode_t Adpt_UdsCallBackWriteTesterNum(bl_BufferSize_t size,
                                       bl_Buffer_t *buffer,
                                       bl_BufferSize_t *respSize);
extern bl_ResponseCode_t Adpt_UdsCallBackReadMTOC(bl_BufferSize_t size,
                                       bl_Buffer_t *buffer,
                                       bl_BufferSize_t *respSize);


extern bl_u8_t GetSecurityAttCounter();     

extern bl_u8_t FirstGetSeedSucess;
extern void Proc_Wait(void);
