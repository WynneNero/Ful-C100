...
{
    bl_u8_t type;
    bl_ResponseCode_t resCode;
    bl_ResponseCode_t sessionResCode;
    bl_BufferSize_t (*MakeId)(const bl_Buffer_t *buffer, bl_u16_t *id);
};
...
struct _tag_DcmService
{
    bl_u16_t id;
    bl_u16_t number;
    bl_BufferSize_t minSize;
    bl_BufferSize_t maxSize;
    bl_u32_t flag;
    const struct _tag_DcmService *serviceList;
    const struct _tag_DcmServiceHeader *header;
    bl_ResponseCode_t (*Callback)(bl_BufferSize_t size, bl_Buffer_t *buffer,
