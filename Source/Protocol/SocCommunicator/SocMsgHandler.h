...
enum DOIPFRAME_DATALEN
{
    ...
    SN_LEN = 1,
    DATALENTH_LEN =2,
    DOIP_DATALEN = SOURCEID_LEN + TARGETID_LEN + CMDTYPE_LEN + SN_LEN+DATALENTH_LEN,
};
	

enum DOIPFRAME_DATAINDEX
{
//    IPCID_INDEX = 0,
    SOURCEID_INDEX = 0,
    TARGETID_INDEX = SOURCEID_INDEX + SOURCEID_LEN, 
    CMDTYPE_INDEX = TARGETID_INDEX + TARGETID_LEN,
    SN_INDEX = CMDTYPE_INDEX + CMDTYPE_LEN,
    DATALENTH_INDEX =SN_INDEX + SN_LEN,
    DATA_INDEX = DATALENTH_INDEX + DATALENTH_LEN,
};
