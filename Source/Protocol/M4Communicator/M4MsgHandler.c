...
void M4Msg_MoveData_Update(U8 MsgID,U32 Value)
{
    switch(MsgID)
    {
        ...
        case E_M4_Left_PAS_COORDINATE_A_X_U16:
        {
            moveDataSend.send.data[E_Left_PAS_COORDINATE_A_X] = (U8)((Value >> 8) & 0XFF);
            moveDataSend.send.data[E_Left_PAS_COORDINATE_A_X+1] = (U8)((Value >> 0) & 0XFF);
            break;
        } 
		
        case E_M4_Left_PAS_COORDINATE_A_Y_U16:
        {
            moveDataSend.send.data[E_Left_PAS_COORDINATE_A_Y] = (U8)((Value >> 8) & 0XFF);
            moveDataSend.send.data[E_Left_PAS_COORDINATE_A_Y+1] = (U8)((Value >> 0) & 0XFF);
            break;
        } 
		
        case E_M4_Left_PAS_COORDINATE_B_X_U16:
        {
            moveDataSend.send.data[E_Left_PAS_COORDINATE_B_X] = (U8)((Value >> 8) & 0XFF);
            moveDataSend.send.data[E_Left_PAS_COORDINATE_B_X+1] = (U8)((Value >> 0) & 0XFF);
            break;
        } 
		
        case E_M4_Left_PAS_COORDINATE_B_Y_U16:
        {
            moveDataSend.send.data[E_Left_PAS_COORDINATE_B_Y] = (U8)((Value >> 8) & 0XFF);
            moveDataSend.send.data[E_Left_PAS_COORDINATE_B_Y+1] = (U8)((Value >> 0) & 0XFF);
            break;
        } 
		
        case E_M4_Left_PAS_COORDINATE_C_X_U16:
        {
            moveDataSend.send.data[E_Left_PAS_COORDINATE_C_X] = (U8)((Value >> 8) & 0XFF);
            moveDataSend.send.data[E_Left_PAS_COORDINATE_C_X+1] = (U8)((Value >> 0) & 0XFF);
            break;
        } 

        case E_M4_Left_PAS_COORDINATE_C_Y_U16:
        {
            moveDataSend.send.data[E_Left_PAS_COORDINATE_C_Y] = (U8)((Value >> 8) & 0XFF);
            moveDataSend.send.data[E_Left_PAS_COORDINATE_C_Y+1] = (U8)((Value >> 0) & 0XFF);
            break;
        } 

		case E_M4_Left_PAS_COORDINATE_D_X_U16:
        {
            moveDataSend.send.data[E_Left_PAS_COORDINATE_D_X] = (U8)((Value >> 8) & 0XFF);
            moveDataSend.send.data[E_Left_PAS_COORDINATE_D_X+1] = (U8)((Value >> 0) & 0XFF);
            break;
        } 

        case E_M4_Left_PAS_COORDINATE_D_Y_U16:
        {
			moveDataSend.send.data[E_Left_PAS_COORDINATE_D_Y] = (U8)((Value >> 8) & 0XFF);
			moveDataSend.send.data[E_Left_PAS_COORDINATE_D_Y+1] = (U8)((Value >> 0) & 0XFF);
            break;
        } 

        case E_M4_Left_PAS_COORDINATE_DEPTH_U16:
        {
            moveDataSend.send.data[E_Left_PAS_COORDINATE_DEPTH] = (U8)((Value >> 8) & 0XFF);
            moveDataSend.send.data[E_Left_PAS_COORDINATE_DEPTH+1] = (U8)((Value >> 0) & 0XFF);
            break;
        } 
...
//********************************USS Right Side Coordinate *******************************//
#ifdef Both_Side
            case E_M4_Right_PAS_COORDINATE_A_X_U16:
            {
                moveDataSend.send.data[E_Right_PAS_COORDINATE_A_X] = (U8)((Value >> 8) & 0XFF);
                moveDataSend.send.data[E_Right_PAS_COORDINATE_A_X+1] = (U8)((Value >> 0) & 0XFF);
                break;
            } 
            
            case E_M4_Right_PAS_COORDINATE_A_Y_U16:
            {
                moveDataSend.send.data[E_Right_PAS_COORDINATE_A_Y] = (U8)((Value >> 8) & 0XFF);
                moveDataSend.send.data[E_Right_PAS_COORDINATE_A_Y+1] = (U8)((Value >> 0) & 0XFF);
                break;
            } 
            
            case E_M4_Right_PAS_COORDINATE_B_X_U16:
            {
                moveDataSend.send.data[E_Right_PAS_COORDINATE_B_X] = (U8)((Value >> 8) & 0XFF);
                moveDataSend.send.data[E_Right_PAS_COORDINATE_B_X+1] = (U8)((Value >> 0) & 0XFF);
                break;
            } 
            
            case E_M4_Right_PAS_COORDINATE_B_Y_U16:
            {
                moveDataSend.send.data[E_Right_PAS_COORDINATE_B_Y] = (U8)((Value >> 8) & 0XFF);
                moveDataSend.send.data[E_Right_PAS_COORDINATE_B_Y+1] = (U8)((Value >> 0) & 0XFF);
                break;
            } 
            
            case E_M4_Right_PAS_COORDINATE_C_X_U16:
            {
                moveDataSend.send.data[E_Right_PAS_COORDINATE_C_X] = (U8)((Value >> 8) & 0XFF);
                moveDataSend.send.data[E_Right_PAS_COORDINATE_C_X+1] = (U8)((Value >> 0) & 0XFF);
                break;
            } 
        
            case E_M4_Right_PAS_COORDINATE_C_Y_U16:
            {
                moveDataSend.send.data[E_Right_PAS_COORDINATE_C_Y] = (U8)((Value >> 8) & 0XFF);
                moveDataSend.send.data[E_Right_PAS_COORDINATE_C_Y+1] = (U8)((Value >> 0) & 0XFF);
                break;
            } 
        
            case E_M4_Right_PAS_COORDINATE_D_X_U16:
            {
                moveDataSend.send.data[E_Right_PAS_COORDINATE_D_X] = (U8)((Value >> 8) & 0XFF);
                moveDataSend.send.data[E_Right_PAS_COORDINATE_D_X+1] = (U8)((Value >> 0) & 0XFF);
                break;
            } 
        
            case E_M4_Right_PAS_COORDINATE_D_Y_U16:
            {
                moveDataSend.send.data[E_Right_PAS_COORDINATE_D_Y] = (U8)((Value >> 8) & 0XFF);
                moveDataSend.send.data[E_Right_PAS_COORDINATE_D_Y+1] = (U8)((Value >> 0) & 0XFF);
                break;
            } 
        
            case E_M4_Right_PAS_COORDINATE_DEPTH_U16:
            {
                moveDataSend.send.data[E_Right_PAS_COORDINATE_DEPTH] = (U8)((Value >> 8) & 0XFF);
                moveDataSend.send.data[E_Right_PAS_COORDINATE_DEPTH+1] = (U8)((Value >> 0) & 0XFF);
                break;
            }  
	 ...
	 if(moveDataSend.send.isreading == FALSE)
        {
            ...
            moveDataSend.send.id = 0x3301;
            moveDataSend.send.len = 50;
            M4Msg_MoveData_Update(E_M4_YawRateDirection_U8,uart_data_cnt);
...
U8 M4_MsgRcv(M4MsgStruct* prcv)
{
    ...
    if(prcv != NULL)
    {
	    ...
	    if(HAL_Read(DEV_M4DRIVER,msgHand.rcvBuf,M4_MSG_BUF_SIZE))
	    {
...
U16 Target_Distance_Information_Min=0;
U16 Target_TTC=7000;
U16 Target_timestamp0=0;
U16 Target_timestamp1=0;
U16 Target_timestamp2=0;
U16 Target_timestamp3=0;
