...
enum
{
	...
	E_Left_PAS_COORDINATE_A_X = E_RELATIVE_POS_ANGLE +2,
	E_Left_PAS_COORDINATE_A_Y = E_Left_PAS_COORDINATE_A_X +2,
	E_Left_PAS_COORDINATE_B_X = E_Left_PAS_COORDINATE_A_Y +2,
	E_Left_PAS_COORDINATE_B_Y = E_Left_PAS_COORDINATE_B_X +2,
	E_Left_PAS_COORDINATE_C_X = E_Left_PAS_COORDINATE_B_Y +2,
	E_Left_PAS_COORDINATE_C_Y = E_Left_PAS_COORDINATE_C_X +2,
	E_Left_PAS_COORDINATE_D_X = E_Left_PAS_COORDINATE_C_Y +2,
	E_Left_PAS_COORDINATE_D_Y = E_Left_PAS_COORDINATE_D_X +2,
	E_Left_PAS_COORDINATE_DEPTH = E_Left_PAS_COORDINATE_D_Y +2,

	E_RESET_POS_REQ = E_Left_PAS_COORDINATE_DEPTH + 2,
...
#ifdef Both_Side
        E_Right_PAS_COORDINATE_A_X = E_M4_StandStill +1,
        E_Right_PAS_COORDINATE_A_Y = E_Right_PAS_COORDINATE_A_X +2,
        E_Right_PAS_COORDINATE_B_X = E_Right_PAS_COORDINATE_A_Y +2,
        E_Right_PAS_COORDINATE_B_Y = E_Right_PAS_COORDINATE_B_X +2,
        E_Right_PAS_COORDINATE_C_X = E_Right_PAS_COORDINATE_B_Y +2,
        E_Right_PAS_COORDINATE_C_Y = E_Right_PAS_COORDINATE_C_X +2,
        E_Right_PAS_COORDINATE_D_X = E_Right_PAS_COORDINATE_C_Y +2,
        E_Right_PAS_COORDINATE_D_Y = E_Right_PAS_COORDINATE_D_X +2,
        E_Right_PAS_COORDINATE_DEPTH = E_Right_PAS_COORDINATE_D_Y +2,
        
        E_M4MSGCOUNTER = E_Right_PAS_COORDINATE_DEPTH +2,
...
#define M4UART_INITPIN_RX() 	GPIO_SetAlterMode(GPIO_PORT_1, GPIO_PIN_8, E_ALTERFUNC_1, GPIO_OPT_INIT|GPIO_OPT_INPUT); //RX
#define M4UART_INITPIN_TX()		GPIO_SetAlterMode(GPIO_PORT_1, GPIO_PIN_9, E_ALTERFUNC_1, GPIO_OPT_INIT);  //TX
#define SET_RX_OUTPUTMODE()		GPIO_SetOutputMode(GPIO_PORT_1, GPIO_PIN_8, GPIO_OPT_INIT, GPIO_OPT_INIT);
#define SET_TX_OUTPUTMODE()		GPIO_SetOutputMode(GPIO_PORT_1, GPIO_PIN_9, GPIO_OPT_INIT, GPIO_OPT_INIT);
#define SET_RX_OUTPUTLOW()		GPIO_SetVal(GPIO_PORT_1, GPIO_PIN_8, FALSE);
#define SET_TX_OUTPUTLOW()		GPIO_SetVal(GPIO_PORT_1, GPIO_PIN_9, FALSE);
...
U8 M4Msg_Update(U8 MsgID,U32 Value);// if return ERR_FAILED, need recall M4Msg_Update again
